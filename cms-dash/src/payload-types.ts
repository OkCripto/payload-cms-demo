...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'stay-types': StayTypesSelect<false> | StayTypesSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "stay-types_select".
 */
export interface StayTypesSelect<T extends boolean = true> {
  label?: T;
  generateSlug?: T;
  slug?: T;
  updatedAt?: T;
